...
def get_recommendation_genre_seeds():
    ...
    return render_template("recommendations_for_genre.html", genres=cached_genre_seeds, playlist_content=PlaylistContent.empty())
...
def get_recommendations_for_genre():
    ...
    return render_template("recommendations_for_genre.html", genres=cached_genre_seeds, playlist_content=recommendations)
